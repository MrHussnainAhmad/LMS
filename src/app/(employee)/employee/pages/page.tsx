...
import PagesClient from "../../../(superadmin)/sa/pages/PagesClient";
import { db } from "@/db";
...
export const metadata: Metadata = {
  title: "Manage Static Pages | Employee Dashboard",
};

export default async function EmployeePagesManagementPage() {
